...
print('{0:10} {1:<15.0f} {2:<15.5f} {3:<10.3f}'.format("Cl2", n_Cl2_out, x_Cl2_out, x_Cl2*100))
print('{0:10} {1:<15.0f} {2:<15.3f} {3:<10.1f}'.format("H2O", n_H2O_out, x_H2O_out, x_H2O*100))
print('{0:10} {1:<15.0f} {2:<15.3f} {3:<10.1f}'.format("O2", n_O2_out, x_O2_out, x_O2*100))
